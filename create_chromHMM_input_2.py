...
def process_file(options):
    ...
    for line in in0:
        ...
        outfile = os.path.join(options.dir,chrom+"_binary.txt")
        out = open(outfile,"w")
...
def run():
    ...
    #parser.add_option('-m', action='store', type='int', dest='col1', 
    #                  help='column of the unique identifier in the Input list file')
    
    
    (options, args) = parser.parse_args()
    #outdir = os.path.dirname(options.inputlist)
