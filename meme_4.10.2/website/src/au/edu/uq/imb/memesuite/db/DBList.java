...
public class DBList {
  ...
  protected PreparedStatement prepareCategoriesQuery(Connection conn,
      boolean shortOnly, EnumSet<Alphabet> allowedAlphabets) throws SQLException {
    return conn.prepareStatement(SQL.SELECT_UNSORTED_CATEGORIES);
  }

  public List<Category> getCategories(boolean shortOnly, EnumSet<Alphabet> allowedAlphabets) throws SQLException {
  ...
  public List<Listing> getListings(long categoryId, boolean shortOnly,
      EnumSet<Alphabet> allowedAlphabets) throws SQLException {
  ...
  public List<Listing> getListings(long categoryId) throws SQLException {
    ListingView view = new ListingView(categoryId, false, EnumSet.allOf(Alphabet.class));
    return view.items;
  }
  ...
  public class CategoryView extends AbstractView<Category> {
    ...
    protected EnumSet<Alphabet> allowedAlphabets;

    public CategoryView(boolean shortOnly, EnumSet<Alphabet> allowedAlphabets) throws SQLException {
    ...
    protected Category constructData(ResultSet rset) throws SQLException {
      ...
      long cnt = rset.getLong(3);
      return new Category(id, name, cnt);
    }
  }
  ...
  public class ListingView extends AbstractView<Listing> {
    ...
    public ListingView(long categoryId, boolean shortOnly, EnumSet<Alphabet> allowedAlphabets) throws SQLException {
    ...
    protected Listing constructData(ResultSet rset) throws SQLException {
      ...
      EnumSet<Alphabet> alphabets = SQL.intToEnums(Alphabet.class, rset.getInt(4));
