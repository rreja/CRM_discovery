...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="hidden-data">
    ...
    <form id="submit_form" method="post" action="{$site_url}/utilities/meme_request" target="_blank">
  ...
  <xsl:template name="help-popups">
    <div class="pop_content" id="pop_motifs_name">
      ...
      <p>
        <a href="http://meme-suite.org/doc/alphabets.html">
    ...
    <div class="box">
      <xsl:choose>
        <xsl:when test="count(/dreme/motifs/motif) = 0">
          <p><b>No significant motifs were discovered at an <i>E</i>-value threshold of 
	  <xsl:value-of select="model/stop/@evalue"/>.</b></p>
        </xsl:when>
        <xsl:otherwise>
          <p> 
            ...
            motif to another MEME suite program (e.g. Tomtom).<br/>
  ...
  <xsl:template name="program">
    ...
    <div class="bar">
      ...
      <div class="subsection">
        ...
        <textarea rows="5" style="width:100%;" readonly="readonly">
