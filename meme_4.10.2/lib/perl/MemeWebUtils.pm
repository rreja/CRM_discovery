...
use lib qw(/Users/rzr142/Desktop/meme_4.10.2/lib/perl);
...
unless ($@) {
  Log::Log4perl::init('/Users/rzr142/Desktop/meme_4.10.2/etc/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/Users/rzr142/Desktop/meme_4.10.2/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/Users/rzr142/Desktop/meme_4.10.2/etc/job_status.tmpl');
