...
my $service_invocation_log_dir = '/Users/rzr142/People/Yu_Zhang/CRM_discovery/meme_4.10.2/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/Users/rzr142/People/Yu_Zhang/CRM_discovery/meme_4.10.2/etc/job_status.tmpl');
